...
export const NAV_ITEMS = [
  ...
  { id: 'maintenance', label: 'Agendamentos de Revisão', icon: <CalendarClock size={20} /> },
  { id: 'actions', label: 'Planos de Ação', icon: <ShieldAlert size={20} /> },
  { 
    id: 'reports', 
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'config-drivers', label: 'Motoristas', icon: <Users size={16} /> },
