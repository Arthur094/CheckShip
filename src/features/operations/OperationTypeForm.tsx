...
const OperationTypeForm: React.FC<OperationTypeFormProps> = ({ data, onChange }) => {
    return (
        <div className="p-8">
                ...
                <div className="grid grid-cols-12 gap-6">
                    <div className="col-span-12">
                        ...
                        <input
                            ...
                            placeholder="Ex: Carga Seca, Transporte de Combustível"
                        />
                    ...
                    <div className="col-span-12">
                        ...
                        <textarea
                            ...
                            placeholder="Descreva as características deste tipo de operação..."
                        />
                        <div className="flex justify-end mt-1">
