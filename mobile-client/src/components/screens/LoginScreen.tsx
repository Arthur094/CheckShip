    ...
    <main className="flex flex-1 flex-col items-center justify-center px-6 py-10 min-h-screen bg-background-light">
      <div className="w-full max-w-sm space-y-8">
        <div className="flex flex-col items-center gap-6">
          {/* CHECKSHIP Platform Logo */}
          <div className="flex items-center gap-3">
            {/* CS Box */}
            <div className="flex items-center justify-center w-14 h-14 rounded-lg bg-primary shadow-lg">
              <span className="text-2xl font-bold text-white">CS</span>
            </div>
            {/* Brand Text */}
            <div className="flex flex-col">
              <h1 className="text-2xl font-bold text-slate-900 tracking-wide">CHECKSHIP</h1>
              <p className="text-xs text-slate-500 font-medium tracking-widest">FLEET MANAGEMENT</p>
            </div>
          </div>
        </div>
