      ...
      <main className="flex-1 overflow-y-auto pb-32 px-4 no-scrollbar">
        ...
        <div className="mt-4 space-y-4">
          ...
          {filteredItems.map((item) => (
            item.status === 'pending' ? (
              <div key={item.id} className="group relative flex flex-col bg-white rounded-2xl shadow-sm border border-slate-100 border-l-4 border-l-orange-500 overflow-hidden">
                <div className="p-4 flex gap-3">
                  <div className="shrink-0">
                    <div className="w-12 h-12 rounded-lg bg-white flex items-center justify-center text-orange-500">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-1 mt-1">
                      ...
                      <p className="text-sm text-slate-500 truncate">{item.driver}</p>
                    </div>
                  </div>
                </div>
                <div className="px-4 pb-4 pt-0">
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 bg-orange-50 hover:bg-orange-100 text-orange-600 py-2.5 rounded-lg text-sm font-semibold transition-colors disabled:opacity-70 disabled:cursor-wait"
                  >
              ...
              <div key={item.id} className="group flex bg-white rounded-xl shadow-sm border border-slate-200 p-4 gap-4 items-center">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-1 mt-1">
                    <span className="material-symbols-outlined text-[16px] text-slate-400">person</span>
                    <p className="text-sm text-slate-600 truncate">{item.driver}</p>
                  </div>
                </div>
